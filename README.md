...
# Попробовать бота
Вы можете протестировать работу данного кода на примере бота [@AllHomework_bot](https://t.me/AllHomework_bot) в телеграмме. 
# Установка
...
Для этого на GNU/Linux или Mac OS вы можете использовать стандартную утилиту ssh, вызвав её командой: 
```
...
#### Рассылка уведомлений пользователям бота
Чтобы уведомить пользователей бота используйте команду ```/notify```
После этой команды введите то, что вы хотите отправить пользователям бота. Все пользователи, которые подписались на рассылку уведомлений получат ваше сообщение. Остальные - неподписанные пользователи не будут получать уведомлений, пока они не подпишутся.
# Лицензия
